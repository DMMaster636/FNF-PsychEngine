...
class ShaderFunctions
{
	public static function implement(funk:FunkinLua)
	{
		...
		funk.addLocalCallback("initLuaShader", function(name:String) {
			...
			#if (!flash && sys)
			return ShaderHelper.initRuntimeShader(name, false, true);
			#else
		...
		funk.addLocalCallback("setSpriteShader", function(obj:String, shader:String) {
			...
			#if (!flash && sys)
			if(!ShaderHelper.runtimeShaders.exists(shader) && !ShaderHelper.initRuntimeShader(shader, false, true))
			{
			...
			if(leObj != null) {
				var arr:Array<String> = ShaderHelper.runtimeShaders.get(shader);
