...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		save.bind('controls_parappa' #if (flixel < "5.0.0"), 'ninjamuffin99' #end); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		...
		var save:FlxSave = new FlxSave();
		save.bind('controls_parappa' #if (flixel < "5.0.0"), 'ninjamuffin99' #end);
